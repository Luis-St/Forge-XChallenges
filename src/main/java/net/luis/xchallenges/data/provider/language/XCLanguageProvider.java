...
public class XCLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		this.add("arguments." + id + ".randomizer_type.invalid", "Invalid randomizer type provided {0}");
		this.add("arguments." + id + ".randomizer_type.all_not_allowed", "Randomizer type 'all' is not allowed in this context");
		// Broadcast command
		this.add("commands." + id + ".broadcast.get", "Command broadcast mode is set to {0}");
		// Timer command
